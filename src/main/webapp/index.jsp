        ...
        <div class="row clearfix">
            ...
            <div class="col-md-6 column">
                ...
                <div class="input-group search">
                    <input name="bookName" type="text" class="form-control" placeholder="请输入你要检索的书名"style="padding: 20px">
                    <span class="input-group-btn">
                        <button class="btn btn-estore" type="submit" value="查找"><span class="glyphicon glyphicon-search"></span>
                        </button>
                    </span>
                </div>
                </form>
    ...
    <div class="body">
        <div class="row clearfix">
            <div class="col-md-2 column menu" >
                <ul>
                    ...
                    <li href="#collapse${category.id }" data-toggle="collapse" ><span class="glyphicon glyphicon-tags"></span>${category.name}</li>
                    <div id="collapse${category.id }" class="collapse on">
                        <div class="collapse-body">
                        <c:forEach items="${category.sons }" var="son">
                            <a href="list.html">${son.name }</a>
                        </c:forEach>
                        </div>
                    </div>
                    </c:forEach>
        ...
        <div class="row book">
            ...
            <div class="col-md-3 onebook">
                <a href="">
                    <img  src="images/book_index/${book.image }" />
                    <h4>
                        ${book.name }
                    </h4>
                    <p>￥${book.price }</p>
                ...
                <div class="row">
                    <a href="shopCar.do?bookId=${book.id }&returnUrl=index.do">
