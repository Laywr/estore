...
<body>
    ...
    <div class="reg_bg row">
        ...
        <div class="reg_box col-md-7 column">
            <h1>用户注册<span class="glyphicon glyphicon-hand-right">&nbsp;已经有账号<a href="login.jsp">去登录</a></span></h1>
            <form action="regist.do" class="form-horizontal" role="from" method="post">
                
                <div class="form-group">
                    <label class="col-sm-3 control-label">用户名：</label>
                    <div class="col-sm-9">
                        <input class="form-control" id="focusedInput" type="text" name="name" placeholder="请输入您的用户名">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">密码：</label>
                    <div class="col-sm-9">
                        <input class="form-control" id="focusedInput" type="password" name="pwd" placeholder="请设置您的密码">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">邮编：</label>
                    <div class="col-sm-9">
                        <input class="form-control" id="focusedInput" type="text" name="postcode" placeholder="请输入您的邮编 ">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" id="focusedInput" type="text" name="telephone" placeholder="请填写您的联系方式">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">电子邮箱：</label>
                    <div class="col-sm-9">
                        <input class="form-control" id="focusedInput" type="text" name="email" placeholder="请输入您的电子邮箱">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-1">
