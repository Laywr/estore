    ...
    <div class="nav">
        ...
        <div class="body">
            <div class="orderSure row">
                ...
                <a class="col-md-2 column" style="padding: 30px ;color: var(--color) !important" href="index.do">
            ...
            <div class="box-lottery">
                <div class="lottery-wrap" style="transform: rotate(-45deg);">
                    <span class="lottery-span1" data-id="8">
                        <i>京东购物卡<br>10元</i><img src="images/lottery_01.png" alt="杰普卡10">
                    </span>
                    <span class="lottery-span2" data-id="7">
                        <i>京东购物卡<br>20元</i><img src="images/lottery_02.png" alt="杰普卡20">
                    </span>
                    <span class="lottery-span3" data-id="6">
                        <i>京东购物卡<br>50元</i><img src="images/lottery_03.png" alt="杰普卡50">
                    </span>
                    <span class="lottery-span4" data-id="5">
                        <i>京东购物卡<br>100元</i><img src="images/lottery_04.png" alt="杰普卡100">
                    </span>
                    <span class="lottery-span5" data-id="1">
                        <i>谢谢参与</i><img src="images/lottery_05.png" alt="谢谢参与">
                    </span>
                    <span class="lottery-span6" data-id="4">
                        <i>京东购物卡<br>200元</i><img src="images/lottery_06.png" alt="杰普卡200">
                    </span>
                    <span class="lottery-span7" data-id="3">
                        <i>京东购物卡<br>500元</i><img src="images/lottery_07.png" alt="杰普卡500">
                    </span>
